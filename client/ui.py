...
def draw_stats(screen, font):
    font_img = font.render("Score: 0", True, "white")
    font_shadow = font.render("Score: 0", True, "black")
    ...
    for i in range(grid.height):
        for j in range(grid.width):
            ...
            pygame.draw.rect(
                screen,
                color,
                pygame.Rect(x_position, y_position, cell_width, cell_height),
            )
